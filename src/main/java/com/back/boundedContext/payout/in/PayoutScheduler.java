...
public class PayoutScheduler {
    ...
    private void runCollectItemsAndCompletePayoutsBatchJob() throws JobInstanceAlreadyCompleteException, InvalidJobParametersException,
            JobExecutionAlreadyRunningException, JobRestartException {
        ...
        JobExecution jobExecution = jobOperator.start(payoutCollectItemsAndCompletePayoutsJob, jobParameters);
    }
}
